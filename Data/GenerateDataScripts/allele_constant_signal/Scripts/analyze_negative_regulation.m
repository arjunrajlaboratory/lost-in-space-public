%Revision script
%Analyze all negative regulation networks using original metrics. These are
%ultimately uninterpretable as explained in the text
...
load('20220318_negative_regulation_params')
