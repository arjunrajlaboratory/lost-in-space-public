%This script produces Gillespie simulations for custom 2 node network
%used as an example in figure 1
%
%INPUT:
%
...
%%
function generateData_allele_diffRNA_custom_1way_2node(nruns,n_species,n_alleles,gillespiesave,maxgillespie,gen,init,data,type,rand_gen,rand_set,savefileID)
