...
%%
function generateData_signal_allele_multiplereps(nruns,n_species,n_alleles,gillespiesave,maxgillespie,gen,init,data,type,savefileID,initial_pulse_value,pulse_r_deg,preloadID,n_reps)
...
for istruc = 1:nstruc
    ...
    if initial_pulse_value ~= 0
        load(sprintf('S_outpar_%s_prerun_%d_%d_1.mat', preloadID, n_species, istruc));
    ...
    for iruns = 1:nruns
        ...
        clearvars -except gillespiesave savefileID nruns maxgillespie n_species init gen...
            ...
            iruns istruc S P R type n_alleles total_species...
            initial_pulse_value pulse_r_deg initial_values...
            preloadID n_reps
        ...
        tok = make_param_mex_bursts_signal_allele('../Data/gillespie_bursts.txt', '../Data/gillespie_bursts',n_species,n_alleles,iruns,1,1,1.0);
    ...
    if isequal(type,'normal') == 1
        ...
        R_save = sprintf('./../Data/R_outpar_%s_multirep_init_%d_%d',savefileID,n_species,istruc);
        S_save = sprintf('./../Data/S_outpar_%s_multirep_init_%d_%d',savefileID,n_species,istruc);
        P_save = sprintf('./../Data/P_outpar_%s_multirep_init_%d_%d',savefileID,n_species,istruc);
    elseif isequal(type,'asym') == 1
   ...
   for irep = 1:n_reps
    for kmem = 1:1
        ...
        if isequal(type,'normal') == 1
            ...
            S_save = sprintf('./../Data/S_outpar_%s_multirep%d_%d_%d_%d', savefileID,irep,n_species,istruc,kmem);
        elseif isequal(type,'asym') == 1
