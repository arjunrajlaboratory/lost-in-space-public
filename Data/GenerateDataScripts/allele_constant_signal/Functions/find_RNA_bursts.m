%This function finds 'multi-bursts' and calculates burst metrics used in
%the paper
%
%
%INPUT:
...
function [bursts, bursts_duration, bursts_total_nodes, bursts_concurrent_nodes, nodes_fraction_on] = ...
     find_RNA_bursts(n_species,n_alleles, threshold,S_outpar, trim, filter_burst_bool)
...
tbursts = arrayfun(@(s, e) above_thresh(:,s:e), runstarts, runends, 'UniformOutput', false);
