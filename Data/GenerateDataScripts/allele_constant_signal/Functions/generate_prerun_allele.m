function    generate_prerun_allele(nruns,n_species,n_alleles,gillespiesave,maxgillespie,gen,init,data,type,savefileID)
...
for istruc = 1:nstruc
    ...
    for iruns = 1:nruns
        ...
        clearvars -except gillespiesave savefileID nruns maxgillespie n_species init gen...
            ...
            iruns istruc S P R type n_alleles
    ...
    if isequal(type,'normal') == 1
        R_save = sprintf('./../Data/R_outpar_%s_prerun_%d_%d',savefileID,n_species,istruc);
        S_save = sprintf('./../Data/S_outpar_%s_prerun_%d_%d',savefileID,n_species,istruc);
        P_save = sprintf('./../Data/P_outpar_%s_prerun_%d_%d',savefileID,n_species,istruc);
    elseif isequal(type,'asym') == 1
    ...
    for kmem = 1:1
        ...
        if isequal(type,'normal') == 1
            S_save = sprintf('./../Data/S_outpar_%s_prerun_%d_%d_%d',savefileID,n_species,istruc,kmem);
        end
