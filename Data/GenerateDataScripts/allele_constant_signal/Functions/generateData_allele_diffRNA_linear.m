...
%This function is specific for linear networks
%
%INPUT:
%
...
%%
function generateData_allele_diffRNA_linear(nruns,n_species,n_alleles,gillespiesave,maxgillespie,gen,init,data,type,rand_gen,rand_set,savefileID)
...
if isequal(type,'normal') == 1
    load_M_iso = sprintf('./../Data/M_iso_linear%d',n_species);
    load(load_M_iso);
...
for istruc = 1:nstruc
    ...
    for iruns = 1:nruns
        ...
        tok = make_param_mex_bursts_allele_diffRNA('../Data/gillespie_bursts.txt',...
