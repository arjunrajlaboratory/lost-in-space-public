#This script visualizes the OR metric for the example 5 node, degree 1 network of
...
example_heatmap=ggplot(all_data %>% filter(k == 110, n_species ==5, subnet == 1)) +
...
ggsave(paste0(save_directory, "example_heatmap.svg"), example_heatmap)
